...
def plot_score_distribution(agents_df: pd.DataFrame, save_path: str = "plots"):
...
def plot_saboteur_performance(sim_df: pd.DataFrame, save_path: str = "plots"):
    ...
    plt.tight_layout()
    plt.savefig(f"{save_path}/saboteur_performance.png", dpi=300, bbox_inches='tight')
    plt.show()

def plot_collaboration_patterns(results: List[Dict[str, Any]], save_path: str = "plots"):
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig(f"{save_path}/collaboration_patterns.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def main():
    ...
    plot_score_distribution(agents_df)
    plot_saboteur_performance(sim_df)
    plot_collaboration_patterns(results)
