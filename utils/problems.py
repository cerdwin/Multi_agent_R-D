...
class ProblemsManager:
    ...
    def get_unassigned_problem(self, assigned_problems: set = None) -> Optional[Problem]:
        """Get a random unassigned problem"""
        import random
        ...
        if not available_problems:
            # If all problems are assigned, reset and pick from all
            available_problems = problem_ids
        
        if available_problems:
            chosen_id = random.choice(available_problems)
            return self.get_problem(chosen_id)
